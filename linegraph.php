           ...
           <div class="col-xs-2 sidebar">
            ...
            <div class="col-xs-10 content">
               <div id="greeting">
                 ...
                 <p><strong>Keywords currently set to monitor.</strong><br />(Click on keywords to generate its Line Graph)</p>
                    <ul class="monwordstable" id="linegraph_monwordstable">
                    </ul>                 
